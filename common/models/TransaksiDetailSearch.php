...
/**
 * TransaksiDetailSearch represents the model behind the search form of `common\models\TransaksiDetail`.
 */
class TransaksiDetailSearch extends TransaksiDetail
{
    ...
    {
        return [
            [['Id', 'Qty', 'Harga', 'SubTotal'], 'integer'],
            [['KodeTrx', 'KodeBarang'], 'safe'],
        ];
    }
